...
class App extends Component {
  ...
  render() {
    ...
    <>
     ...
     {/* <Center fs> " yaaa A portfolio is a set of pictures by someone, or photographs of examples of their work, which they use when entering competitions or applying for work. "</Center> */}
     <Footer/>
    </Layout>
     </div>
    );
